...
export default function Create() {
    return (
        <div className="page-container min-h-screen">
            ...
            <iframe className="rounded-sm" src="https://open.spotify.com/embed/playlist/37i9dQZF1EpGlQ0q3jwzMZ?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </div>
    )
}