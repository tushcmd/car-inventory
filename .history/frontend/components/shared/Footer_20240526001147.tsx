...
const Footer: FC = () => {
  return (
    <footer className='border-t layout-container'>
        <div className='layout-container flex flex-row gap-5 items-center justify-between py-10'>
            <Logo />
...
<div className="inline-flex p-6 max-w-3xl gap-3 items-center text-center">
            <div>
                <Link
                    href="https://github.com/tushcmd/next-puns-ai"
                    target="_blank"
                    rel="noreferrer"
